...
<body><% int compiler=Integer.parseInt(request.getParameter("compiler"));
...
PreparedStatement pst=(PreparedStatement)con.prepareStatement("insert into st1 values(?,?,?,?,?,?,?)");
...
%>
<jsp:forward page="st2marks.jsp"></jsp:forward>
<%
}catch(Exception e)
{
